...
from scripts.erdb_common import get_schema_properties, get_schema_enums, strip_invalid_name, update_optional
from scripts.sp_effect_parser import parse_status_effects, parse_weapon_effects
...
class AmmoGeneratorData(GeneratorDataBase):
    ...
    def schema_retriever() -> Tuple[Dict, Dict[str, Dict]]:
        ...
        store.update(get_schema_enums("ammo-names", "status-effect-names", "attribute-names", "attack-types", "effect-types", "health-conditions", "attack-conditions"))
